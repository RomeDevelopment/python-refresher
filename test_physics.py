...
class TestPhysics(unittest.TestCase):
    ...
    def test_torque_calculator(self):
        self.assertEqual(physics.calculate_torque(30, 300, 10), 1500)
        self.assertNotEqual(physics.calculate_torque(30, 100, 10), 501)
        self.assertEqual(physics.calculate_torque(180, 2000, 2000), 0)
